...
<section class="relative py-12 sm:py-16">
    <div class="mx-auto w-full max-w-6xl px-6">
        <div class="flex flex-wrap items-end justify-between gap-x-16 gap-y-8 border-t border-line pt-10">
            ...
            <a href="{{ $allLink }}" class="group inline-flex items-center gap-2 text-sm font-medium text-muted hover:text-ink">
            ...
            <a href="{{ $nextLink }}" class="group text-right">
                <span class="block font-mono text-[0.6875rem] tracking-widest text-faint uppercase">{{ $nextLabel }}</span>
                <span class="mt-2 flex items-center gap-3 text-2xl font-display font-medium tracking-tight text-ink sm:text-3xl">
                    {{ $nextTitle }}
                    <svg viewBox="0 0 16 16" class="size-4 fill-current transition-transform duration-200 group-hover:translate-x-1" aria-hidden="true">
